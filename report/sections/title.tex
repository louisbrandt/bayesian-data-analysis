\begin{titlepage} % Suppresses displaying the page number on the title page and the subsequent page counts as page 1
	...
	\HRule\\[0.4cm]
	{\huge\bfseries Bayesian Modelling for Real-World Revenue Forecasting: A Case Study}\\[0.4cm] % Title of your document
	\HRule\\[1.5cm]
	...
	\text{BIBAPRO1PE}\\% Minor heading such as course title
	%------------------------------------------------
	%	Date
	%------------------------------------------------
